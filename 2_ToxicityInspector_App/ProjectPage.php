            ...
            <div class="card-body">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel33">Upload New Files </h4>
                            ...
                            <form method="POST" action="UploadedFileForm.php?name=<?php echo $name; ?>" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="File Name" class="form-control" name="FileName" required>
                                    </div>
                                    <br>
                                    ...
                                    <button type="button" class="btn btn-light rounded-pill float-end" data-bs-toggle="tooltip" data-bs-placement="top" title='-File must be in .csv Format!
                            -You can upload your file with two columns which are comment_text and toxicity or without the toxicity label  '>
                                        <i class="bi bi-info-circle" style="color: #0d6efd;"></i>
                                    </button>

                                    <input class="form-control" type="file" name="UploadedFile" id="formFile" oninput="FileVal();" accept=".csv" required>
                ...
                <script>
                    function deleteFile(FileName, name, ProjectName) {
                        var con = confirm("Are you sure you want to delete " + FileName + " file?") // check if the user sure about deleting the project 
