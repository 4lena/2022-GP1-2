...
def main():
 ...
 fileDir = '/Applications/MAMP/htdocs/ToxicityInspector_R1/'+ newFile
 ...
 LDAvis_data_filepath = os.path.join('/Applications/MAMP/htdocs/ToxicityInspector_R1/Uploads/'+newId)
 if 1 == 1:
 ...
 pyLDAvis.save_html(LDAvis_prepared,'/Applications/MAMP/htdocs/ToxicityInspector_R1/Uploads/'+newId+'.html') 
