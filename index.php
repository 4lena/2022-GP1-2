...
<head>
  ...
  <title>Toxicity Inspector</title>
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">We Offer a Toxicity Detection for your Comments</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Detect your comments toxicity level now!</h2>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Who We Are</h3>
              <h2>Toxicity Inspector is a website that detect the toxicity level of comments, as well as many more features.</h2>
              <p>
              We are a passionate team that decided to build this website to help people who have an online comments system to achieve a healthy comments environment.
              </p>
            </div>
          </div>
    ...
    <section id="vision" class="vision">
      ...
      <header class="section-header">
        <h3>Our Vision</h3>
        <p>Achieve a Healthy Comments Environment for Everyone</p>
      </header>
        ...
        <div class="container" data-aos="fade-up">
          <div class="row gx-0">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
              <div class="content">
                <h3>Our Vision</h3>
                <h2>We strive to become the best option out there for our users when thinking of accurate toxicity detection tools.</h2>
                <p>
                We are forward-looking to granting an accurate, reliable toxicity detection method that will ensure to make a healthy comments environment for everyone.
                </p>
              </div>
            </div>
