...
<head>
  ...
  <title>Toxicity Inspector - User Home Page</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">We Offer a Toxicity Detection for your Files</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Detect the toxicity level now!</h2>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      ...
      <header class="section-header">
        <h3>About Us</h3>
        <p>The Toxicity Inspector Team</p>
      </header>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h2>Toxicity Inspector is a website that detect the toxicity level, as well as many more features.</h2>
              <p>
                We are a passionate team that decided to build this website to help people who have an online system to achieve a healthy environment.
              </p>
            </div>
          </div>
    ...
    <section id="mission" class="mission">
      ...
      <header class="section-header">
        <h3>Our Mission</h3>
        <p>Achieve a Healthy Comment Environment for Everyone</p>
      </header>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/mission.svg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h2>A reliable, accurate toxicity detection method.</h2>
              <p>
                We guarantee to make an accurate, reliable toxicity detection method that will ensure to make a healthy comment environment for everyone.
              </p>
            </div>
          </div>
    ...
    <section id="vision" class="vision">
      ...
      <header class="section-header">
        <h3>Our Vision</h3>
        <p>We Aim to be the Best in The Toxicity Detection Filed</p>
      </header>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h2>Become the best option when thinking of toxicity detection tools.</h2>
              <p>
                We strive to become the best option out there for our users when thinking of an accurate, reliable toxicity detection tool.
              </p>
            </div>
          </div>
            ...
            <div class="row gy-4">
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Address</h3>
                  <p> King Saud University,<br>Riyadh</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+966 555555555<br>+966 575555555</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p> <a href="mailto: toxicityinspector@gmail.com">toxicityinspector@gmail.com</a> <br> <br></p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="#mission">Our Mission</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#vision">Our Vision</a></li>
