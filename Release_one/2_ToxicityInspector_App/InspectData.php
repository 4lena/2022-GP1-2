...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Data Distribution</h1> <!-- link it----------- -->
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Data Distribution</li> <!-- link it----------- -->
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <br>
        <?php
        $command = escapeshellcmd('/Users/hourianalthunayangmail.com/opt/anaconda3/envs/spyder/bin/python InspectData.py "' . $UploadedFile . '" "' . $fileID . '"');
        $output = shell_exec($command);
        ?>

        <br><br>

        <object data="Uploads/<?php echo $fileID ?>.html" width="1200" height="820">
        </object>
