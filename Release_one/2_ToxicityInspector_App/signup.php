    ...
    <div style="width: 90%;" class="wrapper">
      ...
      <div class="form-container">
        ...
        <div class="form-inner">
          <form action="signUpForm.php" method="POST" class="admin">
            <div class="field">
              <input type="text" name="username" pattern="[a-z\d]{4,}" title="Please enter lowercase letters and numbers only, and at least 4 or more characters" placeholder="Username" required>
            </div>
            ...
            <div class="field">
              <input type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Please enter at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" required>
            </div>
            <div class="field fb">
